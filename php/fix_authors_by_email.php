...
// Antes este endpoint no verificaba sesión: con un simple POST apply=1
// cualquiera podía disparar el UPDATE masivo sobre noticias.autor_id, sin
// ser admin. Mismo guard que usa el resto de php/admin/*.php.
...
$sqlPreview = "SELECT n.id AS noticia_id, n.titulo, n.autor_id AS noticia_autor_id, n.autor_email,
                u.id AS usuario_id, u.nombre, u.correo AS usuario_correo
               FROM noticias n
