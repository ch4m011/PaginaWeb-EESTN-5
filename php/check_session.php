...
// Antes esto escribía 2 líneas al log en CADA llamada (incluye el volcado
// completo de $_SESSION), y este endpoint lo llaman panel_escritor.js y
// panel_admin.js en cada carga de página — inflaba el log de errores de
// Apache/PHP sin necesidad. Se quita el logging de rutina.
$response = [
