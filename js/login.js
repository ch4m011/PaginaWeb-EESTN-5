...
window.handleGoogleSignIn = async function (response) {
  try {
    if (!response?.credential) {
      throw new Error('Google no devolvió las credenciales.');
    }
    ...
    try {
      ...
      showMessage('El servidor devolvió una respuesta inválida al iniciar sesión con Google.');
      return;
    }
    ...
    showMessage(
      err.message ||
      'No se pudo procesar el inicio de sesión con Google.'
    );
  }
};