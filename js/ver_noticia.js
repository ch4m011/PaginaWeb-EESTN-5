document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    let autorFoto = 'img/logo-tecnica.png';
      ...
      <article class="noticia-articulo">
        <header class="noticia-header">
          ...
          <div class="noticia-meta">
            <img class="noticia-meta__avatar" src="${autorFoto}" alt="${autorNombre}" onerror="this.onerror=null;this.src='../img/logo-tecnica.png'">
            <div class="noticia-meta__info">
              <span class="noticia-meta__autor">${autorNombre}</span>
